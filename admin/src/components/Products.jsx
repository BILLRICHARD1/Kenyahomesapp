        ...
        <div className="p-6">
            <div className="flex justify-between items-center mb-8">
                <div>
                    ...
                    <p className="text-zinc-600 mt-1">Manage Inventory</p>
                </div>

                <Dialog>
                    <form>
                        <DialogTrigger render={
                            <Button className="bg-black text-white px-3 py-6 flex flex-row space-x-3">
                                Add New Product
                                <Plus className="w-5 h-5" />
                            </Button>
                        } />
                        <DialogContent className="sm:max-w-sm bg-white text-black sm:min-w-[600px] border-none">
                            <DialogHeader>
                            ...
                            <FieldGroup>
                                <Field>
                                    ...
                                    <Input id="product-name" name="product-name" placeholder="Enter product name" />
                                </Field>
                                <Field>
                                    <Label htmlFor="product-price">Price per Kg</Label>
                                    <Input id="product-price" name="product-price" placeholder="Enter product price" />
                                </Field>
                            </FieldGroup>
                            <DialogFooter>
                                <DialogClose render={<Button variant="outline px-3 py-2">Cancel</Button>} />
                                <Button type="submit" className="bg-black text-white px-3 py-2">Save changes</Button>
                            </DialogFooter>
                        </DialogContent>
                    </form>
                </Dialog>
            ...
            <div className="flex justify-between items-center mb-6">
                ...
                <div className="text-sm text-zinc-500">
                    Showing {paginatedUsers.length} of {filteredUsers.length} products
                </div>
            </div>
                            ...
                            <tr key={user.id} className="border-b border-zinc-100 hover:bg-zinc-50 transition-colors">
                                ...
                                <td className="py-5 px-6">
                                    <span className={`inline-flex items-center gap-1.5 px-3 py-1 rounded-full text-sm
                                        ...
                                        {user.role === 'store' && <StoreIcon size={16} />}
