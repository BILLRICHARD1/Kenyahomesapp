...
const RegisterScreen = () => {
    const [username, setUsername] = useState('Qode');
    const [phone, setPhone] = useState('0141447430');
        ...
        <SafeAreaView className="flex-1 bg-white p-5">
            <KeyboardAvoidingView behavior={Platform.OS === 'ios' ? 'padding' : 'height'} className="flex-1">
                <ScrollView contentContainerStyle={{ flexGrow: 1 }} keyboardShouldPersistTaps="handled">
                    ...
                    <Text className="text-gray-500 mb-10">Register as a landlord to list your properties</Text>

                    <AuthInput label="Full Name" placeholder="Your full name" value={username} onChangeText={setUsername} />
