        ...
        <SafeAreaView className="flex-1 bg-white p-5">
            <KeyboardAvoidingView behavior={Platform.OS === 'ios' ? 'padding' : 'height'} className="flex-1">
                <ScrollView contentContainerStyle={{ flexGrow: 1 }} keyboardShouldPersistTaps="handled">
                    <Text className="text-3xl font-bold text-gray-900 mb-1 mt-8">Welcome back</Text>
                    <Text className="text-gray-500 mb-10">Sign in to discover your next home.</Text>
                    ...
                    <View className="flex-row justify-center mt-4">
                        ...
                        <TouchableOpacity onPress={() => navigation.navigate('Register')}>
                            <Text className="font-semibold text-[#16a34a]">Sign up</Text>
                        </TouchableOpacity>
                    </View>
                </ScrollView>
